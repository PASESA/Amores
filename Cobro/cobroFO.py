...
# Abrir la imagen y cambiar su tamaño
img = Image.open("LOGONEW.jpg")
new_size = (300, 250)  # Tamaño deseado en píxeles
img_logo = img.resize(new_size)
...
class FormularioOperacion:
	def __init__(self):
		...
		self.ventana1=tk.Tk()
		self.ventana1.title("AMORES COBRO")
...
#            self.label10.configure(text=(""))
	...
	def Comprobante(self):
		...
		folioactual=str(self.nuevo_folio)
